(() => {
  ...
  frame.innerHTML = `
    <svg class="admin-icon-sprite" aria-hidden="true">
      ...
      <symbol id="admin-icon-clock" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></symbol>
...
(() => {
  ...
  const pageStyleNames = new Set(['home.css', 'regions.css', 'quality-review-shell.css', 'public-data-changes.css', 'service-analytics.css', 'toilets.css', 'opening-hours.css'])
  ...
  const ensureIconAliases = () => {
    ...
    const aliases = [
      ...
      ['admin-icon-scan', 'icon-scan-line'], ['admin-icon-compare', 'icon-compare'], ['admin-icon-clock', 'icon-clock'], ['admin-icon-activity', 'icon-activity'],
