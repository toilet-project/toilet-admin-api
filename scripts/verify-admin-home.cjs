...
assert.match(regionHtml, /\/quality-review-shell\.css\?v=1/)
assert.match(qualityHtml, /\/quality-review-shell\.css\?v=1/)
assert.match(qualityReviewShellCss, /body\.quality-page,\s*body\.region-page\s*\{\s*overflow:\s*hidden/)
assert.match(qualityReviewShellCss, /\.quality-page-header,\s*\.admin-page \.region-page-header[^}]*width:\s*min\(calc\(100% - 56px\), 1850px\)/s)
assert.match(qualityReviewShellCss, /\.quality-workspace,\s*\.admin-page \.region-workspace[^}]*max-width:\s*1850px/s)
assert.match(qualityReviewShellCss, /@media \(max-width:\s*900px\)[\s\S]*body\.region-page\s*\{\s*overflow:\s*auto/)
